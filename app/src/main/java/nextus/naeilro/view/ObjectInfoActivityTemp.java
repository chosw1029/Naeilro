...
import nextus.naeilro.databinding.ActivityObjectInfoTempBinding;
...
import nextus.naeilro.viewmodel.ObjectInfoVMTemp;
...
public class ObjectInfoActivityTemp extends BaseActivity implements ObjectInfoVMTemp.DataListener {

    ObjectInfoVMTemp objectInfoVM;
    public ActivityObjectInfoTempBinding binding;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_object_info_temp);
        objectInfoVM = new ObjectInfoVMTemp(this, item.getContentid(), item);
        ...
        //binding.objectInfo.objectDes.setHtml(item.getLocDes());
        setUpLayout();
        setUpRecycler();
    }
    ...
    {
        binding.objectInfo.objectSite.setHtml(url);
    }
    ...
    public void setUpRecycler()
    {
        ...
        Query postsQuery = mDatabase.child("reviews").orderByChild("oid").equalTo(""+item.getContentid()).limitToFirst(3);
